...
define i64 @"<lgt>operator +(usize, f16)"(i64 %0, half %1) {
.entry:
  %2 = uitofp i64 %0 to half
  %3 = fadd half %2, %1
  ret half %3
...
define i64 @"<lgt>operator +(f16, usize)"(half %0, i64 %1) {
.entry:
  %2 = uitofp i64 %1 to half
  %3 = fadd half %0, %2
  ret half %3
...
define i64 @"<lgt>operator +(usize, f32)"(i64 %0, float %1) {
.entry:
  %2 = uitofp i64 %0 to float
  %3 = fadd float %2, %1
  ret float %3
...
define i64 @"<lgt>operator +(f32, usize)"(float %0, i64 %1) {
.entry:
  %2 = uitofp i64 %1 to float
  %3 = fadd float %0, %2
  ret float %3
...
define i64 @"<lgt>operator +(usize, f64)"(i64 %0, double %1) {
.entry:
  %2 = uitofp i64 %0 to double
  %3 = fadd double %2, %1
  ret double %3
...
define i64 @"<lgt>operator +(f64, usize)"(double %0, i64 %1) {
.entry:
  %2 = uitofp i64 %1 to double
  %3 = fadd double %0, %2
  ret double %3
...
define i64 @"<lgt>operator +(isize, f16)"(i64 %0, half %1) {
.entry:
  %2 = sitofp i64 %0 to half
  %3 = fadd half %2, %1
  ret half %3
...
define i64 @"<lgt>operator +(f16, isize)"(half %0, i64 %1) {
.entry:
  %2 = sitofp i64 %1 to half
  %3 = fadd half %0, %2
  ret half %3
...
define i64 @"<lgt>operator +(isize, f32)"(i64 %0, float %1) {
.entry:
  %2 = sitofp i64 %0 to float
  %3 = fadd float %2, %1
  ret float %3
...
define i64 @"<lgt>operator +(f32, isize)"(float %0, i64 %1) {
.entry:
  %2 = sitofp i64 %1 to float
  %3 = fadd float %0, %2
  ret float %3
...
define i64 @"<lgt>operator +(isize, f64)"(i64 %0, double %1) {
.entry:
  %2 = sitofp i64 %0 to double
  %3 = fadd double %2, %1
  ret double %3
...
define i64 @"<lgt>operator +(f64, isize)"(double %0, i64 %1) {
.entry:
  %2 = sitofp i64 %1 to double
  %3 = fadd double %0, %2
  ret double %3
...
define i8 @"<lgt>sex(i8)"(i8 %0) {
.entry:
  %var.integer = alloca i8, align 1
  store i8 %0, ptr %var.integer, align 1
  %1 = load i8, ptr %var.integer, align 1
  ret i8 %1
}
